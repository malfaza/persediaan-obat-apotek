                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href='<?php echo e(url('outgoings/create')); ?>' class="btn btn-primary">+ Tambah Data</a>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="col-md-1">ID Keluar</th>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?php echo e(route('outgoing.import')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laravel\stockManagement\resources\views/outgoings/index.blade.php ENDPATH**/ ?>