                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href='<?php echo e(url('suppliers/create')); ?>' class="btn btn-primary">+ Tambah Data</a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='<?php echo e(url('suppliers/'.$item->id.'/edit')); ?>' class="btn btn-warning btn-sm">Edit</a>
                                            <form class="d-inline" action="<?php echo e(url('suppliers/'.$item->id)); ?>" method="POST">
                                            </form>
                                        </td>
                                    </tr>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="importModalLabel">Import Data Supplier</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form action="<?php echo e(route('supplier.import')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laravel\stockManagement\resources\views/suppliers/index.blade.php ENDPATH**/ ?>