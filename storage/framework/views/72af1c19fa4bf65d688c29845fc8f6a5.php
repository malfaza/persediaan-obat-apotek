            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href='<?php echo e(url('products/create')); ?>' class="btn btn-primary">+ Tambah Data</a>
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2">Stok Tersedia</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($product->total_stock); ?></td>
                                <td>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="importModalLabel">Import Produk</h1>
...
<?php /**PATH C:\laravel\stockManagement\resources\views/products/index.blade.php ENDPATH**/ ?>