                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href='<?php echo e(url('types/create')); ?>' class="btn btn-primary">+ Tambah Data</a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='<?php echo e(url('types/'.$item->id.'/edit')); ?>' class="btn btn-warning btn-sm">Edit</a>
                                            <form class="d-inline" action="<?php echo e(url('types/'.$item->id)); ?>" method="POST">
                                            </form>
                                        </td>
                                    </tr>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo e(route('type.import')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laravel\stockManagement\resources\views/types/index.blade.php ENDPATH**/ ?>