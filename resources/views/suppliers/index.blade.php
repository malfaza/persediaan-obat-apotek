                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href='{{url('suppliers/create')}}' class="btn btn-primary">+ Tambah Data</a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='{{url('suppliers/'.$item->id.'/edit')}}' class="btn btn-warning btn-sm">Edit</a>
                                            <form class="d-inline" action="{{url('suppliers/'.$item->id)}}" method="POST">
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
